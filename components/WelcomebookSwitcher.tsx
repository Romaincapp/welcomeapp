          ...
          <div className="absolute top-full left-0 mt-2 w-64 bg-white border border-gray-200 rounded-lg shadow-lg z-50 max-h-80 overflow-y-auto">
            <div className="p-2">
              ...
              <button
                ...
                className="w-full mt-2 px-3 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition flex items-center justify-center gap-2 font-semibold text-sm"
              >
                <Plus size={16} />
                Créer un nouveau Welcomebook
              </button>
            </div>
          </div>
        </>
