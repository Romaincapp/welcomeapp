-- Correction de la vue manager_categories
-- Ajout des compteurs analytics manquants : total_media, total_views, total_clicks
-- Date : 2025-11-17

-- =============================================================================
-- VUE : manager_categories (CORRIGÉE)
-- =============================================================================
-- Catégorisation des gestionnaires par niveau d'activité + analytics complètes
...
COMMENT ON VIEW manager_categories IS 'Catégorisation des gestionnaires par niveau d''activité avec analytics complètes (tips, médias, vues, clics)';
